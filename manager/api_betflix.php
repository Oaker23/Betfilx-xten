...
class imi {
 ...
 public function balance_agent(){
    $data='username='.$this->agent.$username;
    $res = $this->Curl("GET", 'https://api.bfx.fail/v4/agent/balance?upline=btestdemo', $data);
...
$api = new imi($agent,$key_betflix);
 ...
 // echo $api->edit('echms','พี่ใหญ่','0643064192');
 // echo $api->deposit('491mt ','1');
//echo $api->withdraw('g5fd5','2');
// echo $api->Turnover('59ct9');

 

// echo $api->ChangePassword('demo','qwer1234');

// echo $api->register('demo1','Natthaphong Cherdsuphan','aa123456','01/07/2021','yainalove2560@gmail.com','0643064192','124.122.28.27'); //Dob วันที่
